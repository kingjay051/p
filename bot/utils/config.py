...
class Config:
    ...
    BOT_TOKEN: str = os.environ.get("BOT_TOKEN", "7806291126:AAE3ftBeO61zH3XrHaJ1IFvkQEyXGKJtD9Y") #GANTI "7u9jl" DENGAN TOKEN BOT , JANGAN HAPUS TANDA (" ") NYA !!!
    ...
    DATABASE_CHAT_ID = int(os.environ.get("DATABASE_CHAT_ID", -1002547370737)) #GANTI DENGAN DATABASE CHANNEL

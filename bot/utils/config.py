...
class Config:
    ...
    MONGODB_URI: str = os.environ.get("MONGODB_URI", "mongodb+srv://Jesslyn:KontolXD#123@jesslyn.wvy3rsh.mongodb.net/?retryWrites=true&w=majority&appName=Jesslyn") #GANTI "mongodb://root:passwd@mongo" DENGAN URI MONGO , JANGAN HAPUS TANDA (" ") NYA !!!

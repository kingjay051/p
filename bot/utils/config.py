...
class Config:
    ...
    MONGODB_URI: str = os.environ.get("MONGODB_URI", "mongodb://iyaaaaaa:anjingggg@iyaaanjing-shard-00-00.uzkxmrz.mongodb.net:27017,iyaaanjing-shard-00-01.uzkxmrz.mongodb.net:27017,iyaaanjing-shard-00-02.uzkxmrz.mongodb.net:27017/?ssl=true&replicaSet=atlas-uzkxmrz-shard-0&authSource=admin&retryWrites=true&w=majority&appName=iyaaanjing") #GANTI "mongodb://root:passwd@mongo" DENGAN URI MONGO , JANGAN HAPUS TANDA (" ") NYA !!!
